...
<div class="modal fade" tabindex="-1" role="dialog"  aria-hidden="true" id="myModal_page">
  <div class="modal-dialog modal-lg">
    <div class="modal-content row pop_up_modal_package popup_page_bg">   
        <div class="col-md-12 close_button_cols">
          <button type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true" class="iksi">&times;</span>
          </button>
        </div>  
      <div class="col-md-7">
