...
<section class="cover_section_career cover_text_all_h1_p" id="parallax_slide_bg">
    <div class="container">
        <div class="row">
            <div class="col-md-8 text_about_cover">
                <h1>Work With Us</h1>
                ...
                <button class="button_style_gray button_main button__aylen">Portfolio</button>
            </div> 
        </div>
    </div>
</section>

<!-- Career First paragraph -->

<section class="career_first_section">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
